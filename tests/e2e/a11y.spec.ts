...
const ROUTES = ["/", "/blocks", "/mempool", "/charts", "/settings", "/docs", "/wallet", `/block/${TX_BLOCK_HEIGHT}`, `/tx/${TX_ID}`, `/address/${P2}`, "/legal/terms", "/legal/notice", "/legal/privacy", "/legal/cookies"];
