...
const KIND_LABEL: Record<NftEventKind, string> = { mint: "Mint", transfer: "Transfer", trade: "Sale", burn: "Burn" };
const KIND_TONE: Record<NftEventKind, "primary" | "info" | "xch" | "danger"> = { mint: "primary", transfer: "info", trade: "xch", burn: "danger" };
    ...
    <li className="group flex items-center gap-3 py-2.5 text-sm">
      ...
      <div className="flex shrink-0 flex-col items-end gap-0.5">
        ...
        <span className="text-xs text-fg-faint">
          {event.kind === "trade" && event.xchPrice !== null ? `${formatXchDecimal(event.xchPrice)} · ` : ""}
