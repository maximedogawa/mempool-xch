...
export const queryKeys = {
  ...
  blockSpends: (network: NetworkId, hash: string) =>
    ["chain", network, "blockSpends", hash] as const,
  ...
  mempoolSummary: (network: NetworkId, source: string) =>
    ["mempool", network, "summary", source] as const,
  mempoolItem: (network: NetworkId, id: string) => ["mempool", network, "item", id] as const,
  mempoolByCoin: (network: NetworkId, coin: string) =>
    ["mempool", network, "byCoin", coin] as const,
  ...
  cat: (network: NetworkId, id: string, part: string, cursor: string | null = null) =>
