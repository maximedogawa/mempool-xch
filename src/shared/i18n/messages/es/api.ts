...
const messages: Translation<typeof en> = {
  ...
  base: {
    ...
    specs:
      "Especificaciones OpenAPI completas: <code>coinset.org/openapi/full_node_bundled.json</code> y <code>coinset.org/openapi/coinset_bundled.json</code>. Los endpoints marcados como «cualquier nodo completo» también funcionan con tu propio nodo; consulta <link>Ajustes → nodo personalizado</link>.",
  },
  groups: {
  ...
  endpoints: {
    get_blockchain_state:
      "Altura y hash del pico, tamaño y coste del mempool, coste máximo por bloque, dificultad, estado de sincronización.",
    get_fee_estimate:
      "Estimación de comisión por coste para uno o varios tiempos de confirmación objetivo.",
    get_all_mempool_tx_ids: "Todos los ids de spend bundle que hay ahora en el mempool.",
    get_all_mempool_items:
      "Todos los spend bundles pendientes completos. Es grande (decenas de MB); la app lo compara con los ids que ya tiene en lugar de volver a descargarlo entero.",
    ...
    get_block:
      "El bloque completo (información del generador, reclamaciones de recompensa) por hash de cabecera.",
    get_block_spends:
    ...
    get_transactions_by_cat_asset_id: "Historial de transacciones de un asset id de CAT, paginado.",
    ...
    get_coin_records_by_names: "Registros de monedas a partir de una lista de ids de moneda.",
    ...
    get_coin_records_by_parent_ids:
      "Registros de monedas creadas por una lista de ids de moneda padre.",
    ...
    get_coin_details: "Semántica de la moneda (tipo, asset id) cuando Coinset puede clasificarla.",
    push_tx: "Envía un spend bundle al mempool.",
    ...
    get_raw_transaction_by_id:
      "Elemento tipo mempool (gastos de monedas, adiciones, eliminaciones) de un bundle incluso después de salir del mempool.",
  },
  otherData: {
    title: "Otros datos",
    dexie:
