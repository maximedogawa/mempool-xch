...
const messages: Translation<typeof en> = {
  ...
  history: {
    ...
    action: "diario · últimos dos años",
    seriesLabel: "Serie",
    ...
    note: "Las series del rastreador del panel Peer Info, una muestra al día, a la fecha de la instantánea.",
    versionsTitle: "Versiones a lo largo del tiempo",
    versionsAction: "diario · último año",
