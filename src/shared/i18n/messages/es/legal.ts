  ...
  privacy: {
    ...
    thirdParties: {
      ...
      items: {
        ...
        xchPrice:
          "Precio de XCH: en las páginas Tokens, Cartera y de dirección, y para el historial de precios de la página Gráficos, el precio XCH/USD y su variación de 24 horas proceden de la API pública de datos de mercado de Gate.io (api.gateio.ws), consultada como mucho una vez por minuto. Las solicitudes no incluyen datos de cuenta, claves ni billetera.",
      },
      basis:
