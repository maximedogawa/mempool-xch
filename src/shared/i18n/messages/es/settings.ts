...
const messages: Translation<typeof en> = {
  ...
  network: {
    ...
    active: "Red activa",
    intro:
      "Toda la app sigue a la red activa: prefijos de dirección, enlaces del explorador, el stream en vivo y el resumen del mempool. Endpoint activo: <endpoint>{url}</endpoint>",
  },
  endpoints: {
