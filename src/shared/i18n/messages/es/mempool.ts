...
const messages: Translation<typeof en> = {
  ...
  costUsedHint:
    "Coste CLVM total de todos los spend bundles pendientes frente al límite de la mempool del nodo (el equivalente a 10 bloques).",
  ...
  chartLabel: "Coste de la mempool por franja de comisión a lo largo del tiempo",
