...
const messages: Translation<typeof en> = {
  ...
  title: "Chia 金库",
  tooltip:
    "Chia 金库将花费权与币分离：由通行密钥（passkey）、硬件密钥或 m-of-n 签名者控制一个单例（singleton），恢复路径允许所有者在一段延迟后重新获得访问权，金库可在此期间撤回。Coinset 会推送恢复步骤，但没有金库目录；下方链接的扫描器收录了所有金库。",
