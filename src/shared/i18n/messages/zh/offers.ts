...
const messages: Translation<typeof en> = {
  ...
  card: {
    ...
    statusGroup: "报价状态",
    emptyAddress: {
      open: "没有以此地址为发起方的未成交报价记录。",
      confirmed: "没有以此地址为发起方的已成交报价记录。",
      cancelled: "没有以此地址为发起方的已取消报价记录。",
      expired: "没有以此地址为发起方的已过期报价记录。",
      pending: "没有以此地址为发起方的成交中报价记录。",
    },
    emptyAsset: {
      open: "该资产没有已索引的未成交报价。",
  ...
  page: {
    ...
    noExpiry: "未设置到期",
    fee: "手续费",
    offeredByMaker: "由发起方支付",
    trade: "交易内容",
    makerOffers: "发起方提供",
    makerRequests: "发起方要求",
    makerAddresses: { other: "发起方地址" },
    unknown: "未知。",
    settlement: "结算",
