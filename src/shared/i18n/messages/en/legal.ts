  ...
  privacy: {
    ...
    thirdParties: {
      ...
      items: {
        ...
        xchPrice:
          "XCH price: on the Tokens, Portfolio and address pages and for the Charts page's price history, the XCH/USD price and its 24-hour change come from Gate.io's public market data API (api.gateio.ws), asked at most once a minute. The requests carry no account, key or wallet data.",
      },
      basis:
