...
const messages: Translation<typeof en> = {
  ...
  bidToAsk: "bestes Gebot bis bester Ask",
  sources: "Quellen",
  ...
  selectUsdc: "USDC wählen, um zu vergleichen",
  differentQuote: "Anderes Quote-Asset; Vergleich deaktiviert",
  waitingBoth: "Warte auf beide Orderbücher",
  dexNote:
  ...
  howToReadBody:
    "Käufer stehen Verkäufern um den Mittelkurs gegenüber. Das beste Gebot ist der höchste Preis, den Käufer derzeit bieten; der beste Ask ist der niedrigste Verkaufspreis. Eine veraltete Quelle bleibt mit ihrer letzten Aktualisierung sichtbar und fließt nie in das börsenübergreifende Aggregat ein.",
  inspired:
