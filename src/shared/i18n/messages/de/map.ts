...
const messages: Translation<typeof en> = {
  ...
  history: {
    ...
    action: "täglich · letzte zwei Jahre",
    seriesLabel: "Reihe",
    total: "Full Nodes",
    ...
    note: "Die Crawler-Reihen des Peer-Info-Dashboards, ein Wert pro Tag, Stand des Snapshots.",
    versionsTitle: "Versionen im Zeitverlauf",
    versionsAction: "täglich · letztes Jahr",
